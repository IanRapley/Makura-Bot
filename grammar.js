...
var grammar = {
    Lexer: undefined,
    ParserRules: [
    {"name": "main$subexpression$1", "symbols": ["Title", {"literal":"\n"}, "ADJNOUN", {"literal":"\n"}, "ADJNOUN", {"literal":"\n"}, "ADJNOUN"]},
    ...
    {"name": "SEASON$string$8", "symbols": [{"literal":" "}, {"literal":"s"}, {"literal":"p"}, {"literal":"r"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "SEASON", "symbols": ["SEASON$string$8"]},
    {"name": "SEASON$string$9", "symbols": [{"literal":" "}, {"literal":"s"}, {"literal":"u"}, {"literal":"m"}, {"literal":"m"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "SEASON", "symbols": ["SEASON$string$9"]},
    {"name": "SEASON$string$10", "symbols": [{"literal":" "}, {"literal":"w"}, {"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "SEASON", "symbols": ["SEASON$string$10"]},
    {"name": "SEASON$string$11", "symbols": [{"literal":" "}, {"literal":"d"}, {"literal":"a"}, {"literal":"w"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
