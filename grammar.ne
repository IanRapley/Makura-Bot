...
TIMEWHEN -> TIME " when" SETTING " and" EVENTS

#EVENTSTRUCTURE
TIME -> "Once"|"One day"|"One time"|"One day"|"Back"|"In the" DATE
SETTING -> " the Empress was in mourning"|" I was new to the palace"|" I was travelling"|" I was in " LOCATIONOUT|" it was the" FESTIVAL " festival"|" my" RELATIVE " was visiting"|" we were compsing poems"|" we were choosing incense"|RELATIVE " was just leaving"
FESTIVAL -> " Tanabata"|" Mibune"|" Obon"|" New year's"|" flower"
EVENTS -> " I saw" PALACEEVENT
...
LOCATIONOUT -> " Oji"|" Hyuga"|" Nara"|" Ise"
